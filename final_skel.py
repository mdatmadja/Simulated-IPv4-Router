...
class final_topo(Topo):
  def build(self):
    ...
    self.addLink(s11, h10, port1=8, port2=0)
    self.addLink(s11, h20, port1=9, port2=0)
    self.addLink(s12, h30, port1=8, port2=0)
    self.addLink(s12, h40, port1=9, port2=0)
    self.addLink(s21, h50, port1=8, port2=0)
    self.addLink(s21, h60, port1=9, port2=0)
    self.addLink(s22, h70, port1=8, port2=0)
    self.addLink(s22, h80, port1=9, port2=0)

    self.addLink(s1, s11, port1=8, port2=1)
    self.addLink(s1, s12, port1=9, port2=1)
    self.addLink(s1, s21, port1=10, port2=1)
    self.addLink(s1, s22, port1=11, port2=1)

    self.addLink(s1, h_untrust, port1=12, port2=0)
    self.addLink(s1, h_trust, port1=13, port2=0)
    self.addLink(s1, s3, port1=14, port2=8)
    self.addLink(h_server, s3, port1=0, port2=9)
